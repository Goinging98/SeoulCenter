...
INSERT INTO BOARD VALUES(0, 6, 39, '[서울가볼만한곳/핫플]한남동 카페 narrow path',  '빨간네온사인이 보이는곳 네로우 패스! 2층과 3층 둘다 운영하는 카페! 2층이 꽉차 있어서 3층으로 올라갔다. 가격대는 뭐 한남동 알다시피 비싸니 비싸다.. 그래도 맛있어보이는건 잔뜩(?)! 밀크티와 얼그레이바스크 치즈케이크를 주문했다. 치즈케이크가 엄청 거대하다.. 소스가 많아서 느끼할것같지만 정말 맛있었던 평가..! 네로우 패스 너 정말 좋은데구나(?) 공간도 엄청 넓었다 한남동하면 꼭 와봐야하는 네로우 패스 회사사람들이 추천해줘서 갔는데.. 뭐 유명하다보기보단 달다구리한게 내입맛을 사로잡은 느낌이랄까 다음에 친구들이랑 한번 또 와봐야겠다.', 'B1', '9.jpg', null, DEFAULT, 'Y', DEFAULT, DEFAULT);

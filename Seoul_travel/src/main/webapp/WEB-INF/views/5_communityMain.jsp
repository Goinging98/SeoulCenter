			...
			<div class="ps-lg-3">
				...
				<article class="card card-horizontal border-0 mb-4">
					<a
						...
						href="5.2_communityBlog copy.html"
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						...
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">서울여행
								후기72편 - 용산 삼각지역 맥주집 추천: 용리단길 및 부라보 선술집</a>
						</h3>
				...
				<article class="card card-horizontal border-0 mb-4">
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						...
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">10
				...
				<article class="card card-horizontal border-0 mb-4">
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						...
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">7 Tips
				...
				<article class="card card-horizontal border-0 mb-4">
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						...
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">How to
				...
				<article class="card card-horizontal border-0 mb-4">
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						<a class="fs-sm text-uppercase text-decoration-none" href="#">Inspiration</a>
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">US
								Museum Industry 2021–2024</a>
						</h3>
						<p class="fs-sm text-muted">Nunc vivamus nam vitae ut faucibus
							metus pretium nisl. Elementum sed tincidunt nec aliquam tempus.
				...
				<article class="card card-horizontal border-0 mb-4">
					...
					<div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2">
						...
						<h3 class="h5 pt-1 mb-2">
							<a class="nav-link" href="5.2_communityBlog copy.html">Rocky
				...
				<nav aria-label="Blog pagination">
					<ul class="pagination mb-0">
						...
						<li class="page-item d-none d-sm-block"><a class="page-link"
							href="5_community.html">2</a></li>
						<li class="page-item d-none d-sm-block"><a class="page-link"
							href="5_community.html">3</a></li>
						<li class="page-item d-none d-sm-block">...</li>
						<li class="page-item d-none d-sm-block"><a class="page-link"
							href="5_community.html">8</a></li>
						<li class="page-item"><a class="page-link"
							href="5_community.html" aria-label="Next"><i

                     ...
                     <div class="row g-0">
                       ...
                       <div class="col-md-8">
                         <div class="card-body py-md-2 d-flex flex-column h-100 position-relative">
                           ...
                           <!-- Title -->
                           <h5 class="card-title mb-1"><a href="3.2_foodDetailed.html">1맛집 </a></h5>
                           ...
                           <div class="d-sm-flex justify-content-sm-between align-items-center mt-3 mt-md-auto">
                             ...
                             <div class="mt-3 mt-sm-0">
                               <a href="3.2_foodDetailed.html" class="btn btn-sm btn-dark mb-0 w-100">더보기</a>
                             </div>
                           </div>
                         </div>
                       </div>
                   ...
                   <div class="d-flex justify-content-end pt-4 border-top">
                     <nav aria-label="Blog pagination">
                       <ul class="pagination mb-0">
                         ...
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3_food.html">2</a></li>
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3_food.html">3</a></li>
                         <li class="page-item d-none d-sm-block">...</li>
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3_food.html">8</a></li>
                         <li class="page-item"><a class="page-link" href="3_food.html" aria-label="Next"><i

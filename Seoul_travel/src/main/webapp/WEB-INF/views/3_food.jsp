...
<nav class="border-top pb-md-4 pt-4" aria-label="Pagination">
    ...
    <c:choose>
        <c:when test="${page > 1}">
            <a class="page-link next-page" href="foodMain?page=${page-1}&searchValue=${searchValue}" aria-label="Previous">
        ...
        <c:if test="${page > 3}">
            <li class="page-item d-none d-sm-block">
                <a class="page-link" href="foodMain?page=${page-2}&searchValue=${searchValue}">${page - 2}</a>
            </li>
        </c:if>

        <c:if test="${page > 2}">
            <li class="page-item d-none d-sm-block">
                <a class="page-link" href="foodMain?page=${page-1}&searchValue=${searchValue}">${page - 1}</a>
            </li>
        </c:if>
        ...
        <c:if test="${page < maxPage-1}">
		 ...
		 <c:if test="${page < maxPage}">
        <li class="page-item">
            <a class="page-link next-page" href="foodMain?page=${page+2}&searchValue=${searchValue}" aria-label="Next">

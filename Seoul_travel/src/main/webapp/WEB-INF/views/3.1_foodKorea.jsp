...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
      ...
      <section class="bg-dark-overlay-4"
        style="background-image:url( img/food/platter-gf9324db74_1280.jpg ); background-position: center left; background-size: cover; margin-top: 120px; ">
        <div class="container ">
          <div class="row ">
      ...
      <div class="container mb-md-4 mt-0 pt-4">
        ...
        <nav class="pt-md-3" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><strong>한식</strong></li>
          </ol>
        </nav>
        <!-- Sponsored posts-->
      </div>
              ...
              <div class="offcanvas-body">
                ...
                <div class="d-flex align-items-center mb-4">
                  <label class="d-inline-block me-2 pe-1 text-muted text-nowrap" for="sort"><i
                      class="fi-arrows-sort mt-n1 me-1 align-middle opacity-80"></i> 정렬 : </label>
                ...
                <div class="card card-flush pb-2 pb-lg-0 mb-4 ">
                  <div class="card-body ">
                    <h3 class="h5">카테고리</h3>
                    <a class="nav-link fw-normal d-flex justify-content-between py-1 px-0" href="3.1_foodKorea.html">한식
                      <span class=" ms-394">(2)</span></a>
                    <a class="nav-link fw-normal d-flex justify-content-between py-1 px-0" href="3.1_foodKorea.html">중식
                      <span class=" ms-300">(4)</span></a>
                    <a class="nav-link fw-normal d-flex justify-content-between py-1 px-0" href="3.1_foodKorea.html">양식
                      <span class=" ms-300">(5)</span></a>
                    <a class="nav-link fw-normal d-flex justify-content-between py-1 px-0" href="3.1_foodKorea.html">일식
                      <span class=" ms-300">(5)</span></a>
                  </div>
                </div>
                <!-- Tags-->
                <div class="card card-flush pb-2 pb-lg-0 mb-4">
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap mb-n1">
                      <button class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">이거
                        필요한가요?</button>
                      <button class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">가볼래
                        터~?</button>
                      <button
                        class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">여기어때?</button>
                      <button class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">이집
                        맛집</button>
                      <button class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">이번주
                        핫플</button>
                      <button class="btn btn-xs btn-outline-secondary rounded-pill fs-sm fw-normal me-2 mb-2">SNS
                        핫플!!</button>
                    </div>
                  </div>
                     ...
                     <div class="row g-0">
                       ...
                       <div class="col-md-4 col-sm-12 position-relative">
                         ...
                         <div class=" overflow-hidden rounded-2 ">
                           <div class="tns-carousel-inner" data-autoplay="false" data-arrow="true" data-dots="false"
                             data-items="1">
                             <!-- Image item -->
                             <img
                         ...
                         <div class="card-body py-md-2 d-flex flex-column h-100 position-relative">
                           ...
                           <div class="d-flex justify-content-between align-items-center">
                             <ul class="list-inline mb-0">
                               <li class="list-inline-item me-0 small"><i class="star-rating-icon fi-star-filled active"></i></li>
                               <li class="list-inline-item me-0 small"><i class="star-rating-icon fi-star-filled active"></i></li>
                               <li class="list-inline-item me-0 small"><i class="star-rating-icon fi-star-filled active"></i></li>
                               <li class="list-inline-item me-0 small"><i class="star-rating-icon fi-star-filled active"></i></li>
                               <li class="list-inline-item me-0 small"></i><i class="star-rating-icon fi-star"></i></li>
                             </ul>
                             ...
                             <ul class="list-inline mb-0 z-index-2">
                               ...
                               <li class="list-inline-item dropdown">
                                 ...
                                 <ul class="dropdown-menu dropdown-menu-end min-w-auto shadow rounded"
                                   ...
                                   <li><a class="dropdown-item" href="#"><i class="fab fa-linkedin me-2"></i>LinkedIn</a>
                                   </li>
                                   <li><a class="dropdown-item" href="#"><i class="fa-solid fa-copy me-2"></i>Copy link</a>
                                   </li>
                                 </ul>
                               </li>
                             </ul>
                           ...
                           <!-- Title -->
                           <h5 class="card-title mb-1"><a href="2">1맛집 </a></h5>
                           ...
                           <div class="d-sm-flex justify-content-sm-between align-items-center mt-3 mt-md-auto">
                             ...
                             <div class="mt-3 mt-sm-0">
                               <a href="3.2_foodKoreaDetail.html" class="btn btn-sm btn-dark mb-0 w-100">더보기</a>
                             </div>
                           </div>
                         </div>
                       </div>
                       ...
                       <div class="col-md-4 position-relative">
                         ...
                         <div class=" overflow-hidden rounded-2 ">
                           <div class="tns-carousel-inner" data-autoplay="false" data-arrow="true" data-dots="false"
                             data-items="1">
                             <!-- Image item -->
                             <img src="https://cdn.sommeliertimes.com/news/photo/201904/13073_26162_2932.jpg"
                               style="min-width: 279px; min-height: 209px" alt="Card image">
                           </div>
                         </div>
                         <!-- img END -->
                       ...
                       <div class="col-md-4 position-relative">
                         ...
                         <div class=" overflow-hidden rounded-2 ">
                           <div class="tns-carousel-inner" data-autoplay="false" data-arrow="true" data-dots="false"
                             data-items="1">
                             <!-- Image item -->
                             <img src="https://t1.daumcdn.net/cfile/tistory/231614475363D74809"
                               style="min-width: 279px; min-height: 209px" alt="Card image">
                           </div>
                         </div>
                         <!-- img END -->
                   ...
                   <div class="d-flex justify-content-end pt-4 border-top">
                     <nav aria-label="Blog pagination">
                       <ul class="pagination mb-0">
                         ...
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3.1_foodKorea.html">2</a></li>
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3.1_foodKorea.html">3</a></li>
                         <li class="page-item d-none d-sm-block">...</li>
                         <li class="page-item d-none d-sm-block"><a class="page-link" href="3.1_foodKorea.html">8</a></li>
                         <li class="page-item"><a class="page-link" href="3.1_foodKorea.html" aria-label="Next"><i

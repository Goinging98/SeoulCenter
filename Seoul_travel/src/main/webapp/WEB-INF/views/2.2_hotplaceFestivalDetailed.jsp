...
<div class="container  mt-0 pt-4">
	...
	<nav class="pt-md-3" aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="${path}/hotFestival"><strong>축제/행사</strong></a></li>
	...
	<div class="d-flex justify-content-center">
		<div class="tns-carousel-wrapper overflow-hidden d-flex rounded-3"
			...
			<div class="tns-carousel-inner"	data-carousel-options='{"gutter": 16}'>
				<c:if test= "${not empty fItem.firstimage}">
					<img src="${fItem.firstimage}" alt="Image">
				</c:if>
				<c:if test= "${empty fItem.firstimage}">
					<img src="${path}/resources/img/hotplace/festivalsample.jpeg" alt="Image">
				</c:if>
			</div>
		</div>
	</div>
			...
			<div class="pt-4 pb-5 mb-md-3">
				<div class="d-md-flex align-items-center justify-content-between border-top pt-4">
					<div class="d-flex align-items-center me-3 mb-3 mb-md-0">
						<div class="d-none d-sm-block fw-bold text-nowrap mb-2 me-2 pe-1">홈페이지: ${fItem.homepage}</div>
					</div>
				</div>
			</div>
			<!-- Review modal-->
					...
					<div class="card card-flush pb-3 pb-lg-0 mb-4">
						<div class="card-body">
							...
							<div class="text-nowrap">
								...
								<span class="align-middle">${fItem.addr1}</span>
							</div>
							<div class="ps-4">
								<t class="fs-sm">우편번호 : ${fItem.zipcode}</t>
							</div>
							...
							<div class="text-pre-line">
								...
								<div class="align-middle px-2">${fItem.tel}</div>
							<div class="text-nowrap">
								<i class="fi-info-square fs-lg opacity-70 me-2"></i> 
								<span class="align-middle">안내</span>
							</div>
								<div class="align-middle px-2">- 행사장소</div>
								<div class="align-middle px-3">${fItem.eventplace}</div>
								<div class="align-middle px-2">- 공연시간</div>
								<div class="align-middle px-3">${fItem.playtime}</div>
								<div class="align-middle px-2">- 이용요금</div>
								<div class="align-middle px-3">${fItem.usetimefestival}</div>
							</div>
						</div>
					</div>
				</div>

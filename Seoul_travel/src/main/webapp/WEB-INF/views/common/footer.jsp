				...
				<ul class="nav nav-light flex-column">
					<li class="nav-item mb-2">
						<a class="nav-link p-0 fw-normal text-light text-nowrap" href="mailto:example@gmail.com">
							<i class="fi-mail mt-n1 me-1 align-middle text-primary"></i>Seuoltrip@email.com
						</a>
					</li>
					<li class="nav-item mb-2">
						<a class="nav-link p-0 fw-normal text-light text-nowrap" href="tel:4065550120">
							<i class="fi-device-mobile mt-n1 me-1 align-middle text-primary"></i>(02)1664-2112
						</a>
					</li>
				</ul>
			</div>
		...
		<div
			...
			<p class="order-lg-1 order-2 fs-sm mb-2 mb-lg-0">
				<span class="text-light opacity-60">&copy; All rights
					...
					href="https://createx.studio/" target="_blank" rel="noopener">서울상담소</a>
			</p>
			<div class="d-flex flex-lg-row flex-column align-items-center order-lg-2 order-1 ms-lg-4 mb-lg-0 mb-4">
				<!-- Links-->
				<div class="d-flex flex-wrap fs-sm mb-lg-3 mb-4 pe-lg-10">
					<a class="nav-link-light px-10 mx-10" href="#">개인정보처리방침</a><a
						class="nav-link-light px-2 mx-1" href="#">이용약관</a><a

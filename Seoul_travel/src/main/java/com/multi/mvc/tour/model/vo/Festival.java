...
public class Festival extends TourVO {
	...
	public String getEventplace() {
		return eventplace == null ? "정보없음" : eventplace;
	}
	
	public void setEventplace(String eventplace) {
		if(eventplace == null) {
			this.eventplace = "정보없음";
		} else {
			this.eventplace = eventplace;			
		}
	}
	...
	public String getPlaytime() {
		return playtime == null ? "정보없음" : playtime;
	}
	...
	public String getUsetimefestival() {
		return usetimefestival == null ? "정보없음" : usetimefestival;
	}
